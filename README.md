![UPC_logo_transparente](./assets/UPC_logo_transparente.png)
...
| Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software | <br>**TB1**<br><br>**Garcia Moscoso, Andrea Joselyn**<br><br>Al realizar entrevistas con los arrendatarios, reconocí la importancia del aprendizaje continuo al adaptar mis conocimientos a las necesidades del segmento objetivo. El análisis de estas entrevistas me permitió identificar mejoras clave en el proceso del alquiler. Este proceso reforzó mi compromiso con el aprendizaje permanente, crucial para desarrollar soluciones de software alineadas con las expectativas del usuario.<br><br>**Jeremy Antonio Loayza**<br><br>En esta entrega, me enfoqué en la organización integral del proyecto y la dirección del equipo, asegurando una estructura clara y efectiva para el desarrollo del mismo. Asimismo, desarrollé y validé las suposiciones (Assumptions) y los enunciados de hipótesis (Hypothesis Statements) utilizando el enfoque Lean UX. También fui responsable de la creación y perfeccionamiento de los User Personas y los Empathy Maps, elementos fundamentales para la comprensión de nuestros usuarios objetivo. Finalmente, supervisé la corrección del informe y la supervisión de los avances del equipo, asegurando que el proyecto mantuviera una alta calidad y se alineara con los objetivos establecidos.<br><br>**Sebastian Valente Lobato Pozo**<br><br>Durante esta entrega, me dediqué a la realización del to-be scenario mapping y el desarrollo de entrevistas a los arrendadores y su posterior análisis. A través de este proceso, reconocí la necesidad de actualizar constantemente mis habilidades y conocimientos para poder aplicar las mejores prácticas y herramientas actuales en la industria del software. Esto reforzó mi compromiso con el aprendizaje permanente como un factor crucial para la mejora continua en el desempeño profesional y en la creación de soluciones de software alineadas con las expectativas de los usuarios.<br><br>**Scott Jacobo, Huachaca Advincula**<br><br> A través de la identificación de Problem Statements, el análisis de la competencia y la creación de un Impact Map, desarrollé una sólida capacidad para analizar situaciones complejas, identificar oportunidades y diseñar estrategias efectivas. Esta experiencia me permitió comprender la importancia de un enfoque basado en datos para la toma de decisiones estratégicas en el desarrollo de productos. | <br>**TB1**<br><br>**Garcia Moscoso, Andrea Joselyn**<br><br>Este proceso reforzó mi compromiso con el aprendizaje permanente, crucial para desarrollar soluciones de software alineadas con las expectativas del usuario.<br><br>**Jeremy Antonio Loayza**<br><br>Este proceso me permitió consolidar mis conocimientos en Lean UX y en la gestión de proyectos de software, mejorando mi capacidad para organizar y liderar equipos de trabajo de manera eficiente. Además, la creación y análisis de los User Personas y Empathy Maps me ayudaron a profundizar en la comprensión de los usuarios, lo que es crucial para desarrollar soluciones de software que realmente satisfagan sus necesidades.<br><br>**Sebastian Valente Lobato Pozo**<br><br>Durante la entrega, reconocí que la comunicación es una parte muy importante para realizar el producto, ya que el aprendizaje continuo es crucial para mantener y mejorar el desempeño profesional en el desarrollo de soluciones de software. <br><br>**Scott Jacobo, Huachaca Advincula**<br><br> El proceso de identificar Problem Statements, analizar a la competencia y crear un Impact Map me ha proporcionado una base sólida para tomar decisiones estratégicas informadas y diseñar soluciones innovadoras. |
...
<img src="./assets/asis3.jpg" alt="arrendatarioasis">  
